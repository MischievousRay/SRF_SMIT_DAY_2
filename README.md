As a part of SRF SMIT Workshp/Industrial Training assignment 2 we were to replicate a card with an image, title, description and a button. I wanted to make something meaningful while at that.
